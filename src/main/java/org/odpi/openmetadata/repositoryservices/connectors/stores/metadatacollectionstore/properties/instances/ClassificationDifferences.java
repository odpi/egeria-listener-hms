 ...
 *     <li>Instantiate your own org.odpi.openmetadata.repositoryservices.connectors.stores.metadatacollectionstore.properties.instances.InstancePropertiesDifferences object.</li>
 *     <li>Call the check() method of the org.odpi.openmetadata.repositoryservices.connectors.stores.metadatacollectionstore.properties.instances.InstancePropertiesDifferences object, passing in the getProperties() result
 *          from both the left and right objects retrieved in the first step.</li>
 *     <li>The org.odpi.openmetadata.repositoryservices.connectors.stores.metadatacollectionstore.properties.instances.InstancePropertiesDifferences object will then contain the detailed instance properties differences
...
public class ClassificationDifferences extends Differences
{
    ...
    /**
     * Determine if there is a difference in classifications between the provided org.odpi.openmetadata.repositoryservices.connectors.stores.metadatacollectionstore.properties.instances.EntitySummary objects, and capture
