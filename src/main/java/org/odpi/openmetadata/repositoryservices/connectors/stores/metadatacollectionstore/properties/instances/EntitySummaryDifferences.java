...
/**
 * Capture the differences between org.odpi.openmetadata.repositoryservices.connectors.stores.metadatacollectionstore.properties.instances.EntitySummary objects.  Within this object there are the following distinct areas
 * for which differences are identified:
 * <ul>
 *     <li>org.odpi.openmetadata.repositoryservices.connectors.stores.metadatacollectionstore.properties.instances.ClassificationDifferences - list the differences in classifications, irrespective of the ordering of the
 *          classifications.</li>
 * </ul>
 */
public class EntitySummaryDifferences extends Differences
{
     ...
     *
     * @return org.odpi.openmetadata.repositoryservices.connectors.stores.metadatacollectionstore.properties.instances.ClassificationDifferences
     */
