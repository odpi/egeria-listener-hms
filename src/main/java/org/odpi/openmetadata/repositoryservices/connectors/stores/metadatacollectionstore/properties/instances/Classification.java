...
/**
 * The org.odpi.openmetadata.repositoryservices.connectors.stores.metadatacollectionstore.properties.instances.Classification class stores information about a classification assigned to an entity.  The org.odpi.openmetadata.repositoryservices.connectors.stores.metadatacollectionstore.properties.instances.Classification
...
//                                           methodName);
            throw new RuntimeException("classification name is null ");
        }
        else
        {
            return name;
...
//                                           this.getClass().getName(),
//                                           methodName);
            throw new RuntimeException("Classification constructor passed null template");
        }
        else
        {
            /*
     ...
     *
     * @return org.odpi.openmetadata.repositoryservices.connectors.stores.metadatacollectionstore.properties.instances.ClassificationOrigin enum
     */
     ...
     *
     * @param classificationOrigin org.odpi.openmetadata.repositoryservices.connectors.stores.metadatacollectionstore.properties.instances.ClassificationOrigin enum
     */
    ...
    public String toString() {
        return "org.odpi.openmetadata.repositoryservices.connectors.stores.metadatacollectionstore.properties.instances.Classification{" +
