...
/**
 * org.odpi.openmetadata.repositoryservices.connectors.stores.metadatacollectionstore.properties.instances.EntityProxy summarizes an entity instance.  It is used to describe one of the entities connected together by a
 * relationship.
 */
...
public class EntityProxy extends EntitySummary
{
    ...
    public EntityProxy(EntitySummary   template)
    {
        ...
        else if (template instanceof EntityDetail)
        {
             ...
             * is qualified name.  The problem is that there is no indication in the org.odpi.openmetadata.repositoryservices.connectors.stores.metadatacollectionstore.properties.instances.InstanceProperties of which
     ...
     *
     * @return org.odpi.openmetadata.repositoryservices.connectors.stores.metadatacollectionstore.properties.instances.InstanceProperties iterator
     */
     ...
     *
     * @param uniqueAttributes org.odpi.openmetadata.repositoryservices.connectors.stores.metadatacollectionstore.properties.instances.InstanceProperties iterator
     */
    ...
    public String toString() {
        return "org.odpi.openmetadata.repositoryservices.connectors.stores.metadatacollectionstore.properties.instances.EntityProxy{" +
