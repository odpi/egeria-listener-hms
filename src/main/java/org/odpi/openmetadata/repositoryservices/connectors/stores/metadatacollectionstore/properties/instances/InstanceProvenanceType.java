...
/**
 * org.odpi.openmetadata.repositoryservices.connectors.stores.metadatacollectionstore.properties.instances.InstanceProvenanceType defines where the metadata comes from and, hence if it can be updated.
 * <ul>
 *     <li>
...
public enum InstanceProvenanceType implements Serializable
{
    ...
    {
        return "org.odpi.openmetadata.repositoryservices.connectors.stores.metadatacollectionstore.properties.instances.InstanceProvenanceType{" +
                "ordinal=" + ordinal +
                ", name='" + name + '\'' +
