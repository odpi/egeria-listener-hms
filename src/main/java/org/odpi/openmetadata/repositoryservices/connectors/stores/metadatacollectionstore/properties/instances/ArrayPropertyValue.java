 ...
 * The elements of the array are stored in an org.odpi.openmetadata.repositoryservices.connectors.stores.metadatacollectionstore.properties.instances.InstanceProperties map where the property name is set to the element
...
public class ArrayPropertyValue extends InstancePropertyValue
{
     ...
     *
     * @return org.odpi.openmetadata.repositoryservices.connectors.stores.metadatacollectionstore.properties.instances.InstanceProperties containing the array elements
     */
...
//                                           "setArrayValue");
            throw new RuntimeException("Array Out of bounds, class name= " + this.getClass().getSimpleName() + ", elementNumber= " + elementNumber + ", array count =" + arrayCount );
        }
    }
     ...
     *
     * @param arrayValues org.odpi.openmetadata.repositoryservices.connectors.stores.metadatacollectionstore.properties.instances.InstanceProperties containing the array elements
     */
