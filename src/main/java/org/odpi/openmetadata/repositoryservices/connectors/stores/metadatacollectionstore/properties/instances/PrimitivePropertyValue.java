...
/**
 * org.odpi.openmetadata.repositoryservices.connectors.stores.metadatacollectionstore.properties.instances.PrimitivePropertyValue stores a single primitive property.  This is stored in the specific Java class
...
public class PrimitivePropertyValue extends InstancePropertyValue
{
     ...
     *
     * @param template org.odpi.openmetadata.repositoryservices.connectors.stores.metadatacollectionstore.properties.instances.PrimitivePropertyValue
     */
    ...
    {
        return "org.odpi.openmetadata.repositoryservices.connectors.stores.metadatacollectionstore.properties.instances.PrimitivePropertyValue{" +
...
//                                methodName);
                        throw new RuntimeException("Primitive property value validateValueAgainstType failed for a date : " + ", className=" + primitiveValue.getClass().getName() +",value=" + primitiveValue.getClass().getName());
                    }
                }
                ...
                else if (primitiveDefCategory == PrimitiveDefCategory.OM_PRIMITIVE_TYPE_BYTE)
                {
                    ...
                    return Byte.parseByte(castValue.toString());
                }
                ...
                {
                    Float castValue = (Float)primitiveValue;
                ...
                {
                    Short    castValue = (Short)primitiveValue;

                    return Short.valueOf(castValue);
                }
                else
                {
                    /*
...
//                                                      this.getClass().getName(),
//                                                      methodName);
                    throw new RuntimeException("Primitive property value validateValueAgainstType failed invalid : " + ", className=" + primitiveValue.getClass().getName() + ",category=" + primitiveDefCategory.getName() + ",value=" + primitiveValue.getClass().getName());
                }
            }
        }
...
//                                              unknownPrimitiveClass);
            throw new RuntimeException("Primitive property value validateValueAgainstType class not found  : " + ", className=" + primitiveValue.getClass().getName() + ",category=" + primitiveDefCategory.getName()  );
...
//                                              invalidPrimitiveCategory);
            throw new RuntimeException("Primitive property value validateValueAgainstType invalidPrimitiveCategory : " + " category=" + invalidPrimitiveCategory  );
